            ...
            <div className="content">
              <div className="contact-info" data-aos="fade-right">
                <ul className="circle-cont">
                  <li>
                    <a className="circle2">
                      <i class="fas fa-phone-square-alt"></i>+91 8579087398
                    </a>
                  </li>
                  <li className="mx-auto flex sm:flex-nowrap">
                    <a
                      href="mailto:rajeshbagul2001@gmail.com"
                      className="circle"
                    >
                      <i class="fas fa-envelope-square"></i>
                    </a>
                    ranjan.saket0910@gmail.com
                  </li>
                  <li>
                    <a
                      href="https://github.com/SAKET112"
                      target="_blank"
                      className="circle"
                    >
                  ...
                  <li>
                    <a
                      href="https://www.linkedin.com/in/saket-bihari-757892186/"
                      target="_blank"
                      className="circle"
                    >
                  ...
                  {/* <li>
                    <a className="circle2" >
                      <i class="fab fa-solid fa-location-pin"></i>Nashik, Maharashtra
                    </a>
                  </li> */}
                </ul>
              </div>
